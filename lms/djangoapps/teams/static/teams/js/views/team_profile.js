...
import ViewUtils from 'components/utils/view_utils';

import TeamDiscussionView from 'teams/js/views/team_discussion';
import TeamUtils from 'teams/js/views/team_utils';

import teamTemplate from 'teams/templates/team-profile.underscore';
import teamMemberTemplate from 'teams/templates/team-member.underscore';
import teamAssignmentTemplate from 'teams/templates/team-assignment.underscore';


/**
 * View for an individual team.
*/
const TeamProfileView = Backbone.View.extend({
