...
import SearchFieldView from 'components/views/search_field';
import HeaderView from 'js/components/header/views/header';
import HeaderModel from 'js/components/header/models/header';

import TopicModel from 'teams/js/models/topic';
import TopicCollection from 'teams/js/collections/topic';
import TeamModel from 'teams/js/models/team';
import TeamCollection from 'teams/js/collections/team';
import MyTeamsCollection from 'teams/js/collections/my_teams';
import TeamAnalytics from 'teams/js/utils/team_analytics';
import TeamsTabbedView from 'teams/js/views/teams_tabbed_view';
import TopicsView from 'teams/js/views/topics';
import TeamProfileView from 'teams/js/views/team_profile';
import MyTeamsView from 'teams/js/views/my_teams';
import ManageView from 'teams/js/views/manage';
import TopicTeamsView from 'teams/js/views/topic_teams';
import TeamEditView from 'teams/js/views/edit_team';
import TeamMembersEditView from 'teams/js/views/edit_team_members';
import TeamProfileHeaderActionsView from 'teams/js/views/team_profile_header_actions';
import TeamUtils from 'teams/js/views/team_utils';
import InstructorToolsView from 'teams/js/views/instructor_tools';

import teamsTemplate from 'teams/templates/teams_tab.underscore';

export const TeamsHeaderModel = HeaderModel.extend({
    initialize: function() {
...
export const ViewWithHeader = Backbone.View.extend({
...
export const TeamTabView = Backbone.View.extend({
    initialize: function(options) {
        var view = this,
            router, tabsList;
