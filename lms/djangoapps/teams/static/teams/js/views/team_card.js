...
import teamMembershipDetailsTemplate from 'teams/templates/team-membership-details.underscore';
import teamCountryLanguageTemplate from 'teams/templates/team-country-language.underscore';
import dateTemplate from 'teams/templates/date.underscore';
import HtmlUtils from 'edx-ui-toolkit/js/utils/html-utils';
import StringUtils from 'edx-ui-toolkit/js/utils/string-utils';

export const TeamMembershipView = Backbone.View.extend({
    tagName: 'div',
...
export const TeamCountryLanguageView = Backbone.View.extend({
    initialize: function(options) {
...
export const TeamActivityView = Backbone.View.extend({
    tagName: 'div',
...
export const TeamCardView = CardView.extend({
    initialize: function() {
